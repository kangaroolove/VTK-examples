...
public:
    static MoveFocusPoint *New() { return new MoveFocusPoint; }
...
int main(int, char *[]) {
    ...
    renderers[(int)ViewerPosition::BOTTOM_MIDDLE]->SetViewport(0.33, 0, 0.66,
                                                               0.5);
    renderers[(int)ViewerPosition::BOTTOM_RIGHT]->SetViewport(0.66, 0, 1.0,
                                                              0.5);
    renderers[(int)ViewerPosition::TOP_LEFT]->SetViewport(0, 0.5, 0.33, 1.0);
    renderers[(int)ViewerPosition::TOP_MIDDLE]->SetViewport(0.33, 0.5, 0.66,
                                                            1.0);
    ...
    cursorActors[(int)ViewerPosition::BOTTOM_LEFT]
        ->GetCursorAlgorithm()
        ->SetReslicePlaneNormalToXAxis();
    cursorActors[(int)ViewerPosition::BOTTOM_MIDDLE]
        ->GetCursorAlgorithm()
        ->SetReslicePlaneNormalToYAxis();
    cursorActors[(int)ViewerPosition::BOTTOM_RIGHT]
        ->GetCursorAlgorithm()
        ->SetReslicePlaneNormalToZAxis();
    cursorActors[(int)ViewerPosition::TOP_LEFT]
        ->GetCursorAlgorithm()
        ->SetReslicePlaneNormalToXAxis();
    cursorActors[(int)ViewerPosition::TOP_MIDDLE]
        ->GetCursorAlgorithm()
        ->SetReslicePlaneNormalToYAxis();
    cursorActors[(int)ViewerPosition::TOP_RIGHT]
        ->GetCursorAlgorithm()
        ->SetReslicePlaneNormalToZAxis();
    ...
    renderers[(int)ViewerPosition::BOTTOM_MIDDLE]->GetActiveCamera()->Elevation(
        90);
    renderers[(int)ViewerPosition::BOTTOM_MIDDLE]->GetActiveCamera()->SetViewUp(
        0, 0, -1);
