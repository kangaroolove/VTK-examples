...
void VTKOpenGLWidget::createTestData() {
  ...
  actors[0]->SetDisplayExtent(middleExtentX, middleExtentX, extent[2],
                              extent[3], extent[4], extent[5]);
  actors[1]->SetDisplayExtent(extent[0], extent[1], middleExtentY,
                              middleExtentY, extent[4], extent[5]);
